...
# GET /individuals.json
  ...
  def create
    @individual = Individual.new(params[:individual].permit(:firstname,:lastname,:gender,:gradyear,:type,
                                                             :middlename,:sisid,:login))
  ...
  def update
    ...
    respond_to do |format|
      if @individual.update_attributes(params[:individual].permit(:firstname,:lastname,:gender,:gradyear,:type,
                                                                  :middlename,:sisid,:login))
